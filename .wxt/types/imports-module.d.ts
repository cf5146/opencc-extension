...
declare module '#imports' {
  ...
  export { convertText, convertTextNode, convertAllTextNodes, convertTitle, convertSelection, hasConverted, resetCaches } from '../src/utils/conversion';
  export { setupAutoObserver } from '../src/utils/observer';
  export { SUPPORTED_LOCALES, isLocaleCode, originSetting, targetSetting, autoSetting, whitelistSetting, textboxSizeSetting, LocaleCode } from '../src/utils/storage';
  export { compileWhitelist, matchesWhitelist, WhitelistEntry } from '../src/utils/whitelist';
}
